...
class F045 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<F045Controller>(
        builder: (_) => Scaffold(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          MyTitleText(
                            title: 'نموذج تفويض بإعطاء معلومات من السجل الطبي',
                            color: Colors.black,
                            fontWeight: FontWeight.bold,
                            fontSize: 12,
                          ),
                                ...
                                Row(
                                  children: [
                                    Expanded(
                                      child: MyTitleText(
                                          title:
                                              'This authorization is expired on ',
                                          color: Colors.black),
                                    ),
                                    Expanded(
                                      child: MyTextFormField(
                                        controller: f045Controller
                                            .authorizationENController,
                                        inputFormatters: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: MyTitleText(
                                        title:
                                            'ينتهي العمل بموجب هذا التفويض بتاريخ ',
                                        color: Colors.black,
                                        textDirection: TextDirection.rtl,
                                      ),
                                    ),
                          ...
                          TableRow(children: [
                            myCell(
                              child: Column(
                                ...
                                children: [
                                  MyTitleText(
                                      title: 'I, the undersigned, (Full Name):',
                                      color: Colors.black,
                                      fontSize: 15),
                                  MyTextFormField(
                                    controller:
                                        f045Controller.fullNameENController,
                                    hintMaxLine: 1,
                                    hintText:
                                    ...
                                    children: [
                                      Checkbox(
                                          ...
                                          onChanged: (val) {
                                            ...
                                            f045Controller.legalGuardianEN =
                                                false;
                                            f045Controller.legalGuardianAR =
                                                false;
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: MyTitleText(
                                          title:
                                              'legal Guardian (___________________________)',
                                          color: Colors.black,
                                        ),
                                      ),
                                    ],
                                  ...
                                  MyTitleText(
                                    title:
                                        'Authorize THHC accessing my medical record or releasing my medical information and reports at any time by the following persons:',
                                    color: Colors.black,
                                    fontSize: 16,
                                  ),
                                  //Todo: 1 - 2 - 3 - 4
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Checkbox(
                                          ...
                                          onChanged: (val) {
                                            f045Controller.medicalInfo1EN =
                                                val!;
                                            f045Controller.medicalInfo1AR =
                                                false;
                                            f045Controller.update();
                                          }),
                                      TextCheckbox(
                                        title:
                                            'Medical information related to the treatment of the following medical cases:',
                                        color: Colors.black,
                                        fontSize: 16,
                                      ),
                                    ],
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Checkbox(
                                          value:
                                              f045Controller.onlyMedicalInfoEN,
                                          onChanged: (val) {
                                            f045Controller.onlyMedicalInfoEN =
                                                val!;
                                            f045Controller.onlyMedicalInfoAR =
                                                false;
                                            f045Controller.update();
                                          }),
                                      TextCheckbox(
                                        title:
                                            'Only the medical information for the period',
                                        color: Colors.black,
                                        fontSize: 16,
                                      ),
                                    ],
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      MyTitleText(
                                          title: 'From', color: Colors.black),
                                      Expanded(
                                          child: MyTextFormField(
                                        controller:
                                            f045Controller.fromENController,
                                        hintText:
                                      ...
                                      MyTitleText(
                                          title: 'To', color: Colors.black),
                                      Expanded(
                                          child: MyTextFormField(
                                        controller:
                                            f045Controller.toENController,
                                        hintText:
                                            '______________________________',
                                        hintStyle: const TextStyle(
                                            overflow: TextOverflow.visible),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Checkbox(
                                          value:
                                              f045Controller.allMedicalInfoEN,
                                          onChanged: (val) {
                                            f045Controller.allMedicalInfoEN =
                                                val!;
                                            f045Controller.allMedicalInfoAR =
                                                false;
                                            f045Controller.update();
                                          }),
                                      TextCheckbox(
                                        title:
                                            'All medical information in the medical records without specific dates.',
                                        color: Colors.black,
                                        fontSize: 16,
                                      ),
                                    ],
                            ...
                            myCell(
                              child: Column(
                                ...
                                children: [
                                  MyTitleText(
                                    title: 'انا الموقع أدناه (الاسم بالكامل):',
                                    color: Colors.black,
                                    fontSize: 15,
                                    textDirection: TextDirection.rtl,
                                  ),
                                  MyTextFormField(
                                    controller:
                                        f045Controller.fullNameARController,
                                    hintMaxLine: 1,
                                    hintText:
                                        '_____________________________________________',
                                    textAlign: TextAlign.right,
                                  ...
                                  MyTitleText(
                                    title:
                                        'أفوض توازن للرعاية الطبية المنزلية بالسماح للتالية أسمائهم بالاطلاع على سجلي الطبي وتزويدهم بالمعلومات والتقارير التي يحتاجونها وفي أي وقت:',
                                    color: Colors.black,
                                    fontSize: 16,
                                    textDirection: TextDirection.rtl,
                                  ),
                                  ...
                                  MyTitleText(
                                    title:
                                        'ويقتصر هذا التفويض على المعلومات التالية:',
                                    color: Colors.black,
                                    fontSize: 15,
                                    textDirection: TextDirection.rtl,
                                  ),
                                  Row(
                                    ...
                                    children: [
                                      TextCheckbox(
                                        title:
                                            'المعلومات الطبية الخاصة بمعالجة الحالات المرضية التالية:',
                                        color: Colors.black,
                                        fontSize: 16,
                                        textDirection: TextDirection.rtl,
                                      ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      TextCheckbox(
                                        title:
                                            'المعلومات الطبية التي تغطي الفترة',
                                        color: Colors.black,
                                        fontSize: 16,
                                        textDirection: TextDirection.rtl,
                                      ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      MyTitleText(
                                          title: 'فقط', color: Colors.black),
                                      Expanded(
                                          child: MyTextFormField(
                                        controller:
                                            f045Controller.toARController,
                                        textDirection: TextDirection.rtl,
                                        textAlign: TextAlign.right,
                                        hintText:
                                            '______________________________',
                                      ...
                                      MyTitleText(
                                          title: 'الى', color: Colors.black),
                                      Expanded(
                                          child: MyTextFormField(
                                        controller:
                                            f045Controller.fromARController,
                                        hintText:
                                            '______________________________',
                                        textDirection: TextDirection.rtl,
                                        textAlign: TextAlign.right,
                            ...
                            myCell(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    MyTitleText(
                                        title: 'Date:', color: Colors.black),
                                    Expanded(
                                      child: MyTextFormField(
                                        controller:
                                            f045Controller.dateENController,
                                        hintText:
                                            '_____________________________________',
                                        hintStyle: myHintStyle(),
                                      ),
                                ...
                                Row(
                                  children: [
                                    Expanded(
                                      child: MyTextFormField(
                                        controller:
                                            f045Controller.dateARController,
                                        hintText:
                                            '_____________________________________',
                                        hintStyle: myHintStyle(),
                                        textAlign: TextAlign.right,
