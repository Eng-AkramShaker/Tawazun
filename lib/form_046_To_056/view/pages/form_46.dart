...
class Form46 extends StatelessWidget {
  const Form46({Key? key}) : super(key: key);
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        buildCheckBox(controller.UnSecdule, (val1) {
                          controller.UnSecdule = val1!;
                          controller.update();
                        }, "UnSeclude", 13),
                        buildCheckBox(controller.Other, (val1) {
                    ...
                    Row(
                      children: [
                        ...
                        buildCheckBox(controller.treatmentPlan, (val1) {
                        ...
                        buildCheckBox(controller.containe, (val1) {
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        buildCheckBox(controller.RT, (val1) {
                          controller.RT = val1!;
                          controller.update();
                        }, "RT", 1 * w * 0.01),
                        buildCheckBox(controller.OT, (val1) {
                          controller.OT = val1!;
                          controller.update();
                        }, "OT", 1 * w * 0.01),
                        buildCheckBox(controller.SW, (val1) {
                          controller.SW = val1!;
                          controller.update();
                        }, "SW", 1 * w * 0.01),
                        buildCheckBox(controller.dietition, (val1) {
