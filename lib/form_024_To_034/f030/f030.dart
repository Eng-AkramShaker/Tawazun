        ...
        return Scaffold(
          ...
          body: ListView(
            children: [
              ...
              text_widget_h2(
                  text:
                      '*Acceptable Temperature Range: 2°C to 8°C according to THHC-022 SPECIMEN COLLECTION, HANDLING,\n TRANSPORTATION AND TRACKING'),
              text_widget_h2(
                  text: '*Accepted time less than 2 hour to deliver to lab.'),
              text_widget_h2(
                  text:
                      'Transport a Urine Specimen as soon as possible.\n Unpreserved urine can be processed within 2 hours at room temperature or 24 hours if refrigerated. '),
              text_widget_h2(
                  text:
                      'Transport a Stool specimen as soon as possible. Unpreserved urine can be processed within 2 hours at room '),
