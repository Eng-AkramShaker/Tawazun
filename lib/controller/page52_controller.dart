...
class Form52Controller extends GetxController{
  ...
  void updateCheckboxwestorn(bool value) {westorn = value;update();}
  void updateCheckboxarabic(bool value) {arabic = value;update();}
  void updateCheckboxyes(bool value) {yes = value;update();}
  void updateCheckboxno(bool value) {no = value;update();}
  void updateCheckboxcondme(bool value) {condme = value;update();}
  void updateCheckboxIDC(bool value) {IDC = value;update();}
  void updateCheckDIAPERS(bool value) {diapers = value;update();}
  void updateCheckiNBED(bool value) {iNBED = value;update();}
  void updateCheckonFLOOR(bool value) {onFLOOR = value;update();}
  void updateCheckyesSleeps(bool value) {yesSleeps = value;update();}
  void updateChecknoSleeps(bool value) {noSleeps = value;update();}
  void updateChecyesEQUEMENT(bool value) {yesEQUEMENT = value;update();}
  void updateChecknoEQUEMENT(bool value) {noEQUEMENT = value;update();}
  void updateCheckwhoEQUEMENT(bool value) {whoEQUEMENT = value;update();}
  void updateCheckyesWALKING(bool value) {yesWALKING = value;update();}
  void updateChecknoWALKING(bool value) {noWALKING = value;update();}
  void updateCheckyesWHEELCHAIR(bool value) {yesWHEELCHAIR = value;update();}
  void updateChecknoWHEELCHAIR(bool value) {noWHEELCHAIR = value;update();}
  void updateCheckyesSeetingBalance(bool value) {yesSeetingBalance = value;update();}
  void updateChecknoSeetingBalance(bool value) {noSeetingBalance = value;update();}
  void updateCheckyesStandingBalance(bool value) {yesStandingBalance = value;update();}
  void updateChecknoStandingBalance(bool value) {noStandingBalance = value;update();}
